export const webConfig = {
  ...
  btSearch: [
    ...
    },
    {
      ...
      desc: '磁力搜是一个聚合搜索磁力链接的引擎'
    },
    {
      name: '磁力银行',
      url: 'https://www.loog.monster/',
      icon: 'https://www.loog.monster/assets/images/fav.png',
      desc: 'bt搜索下载神器，最新最全的BT搜索引擎，海量磁力种子信息库'
    },
    {
      name: '磁力车',
      url: 'https://e456.monster/',
      icon: '',
      desc: '最新2019bt种子搜索，最新最专业的BT搜索引擎-BT磁链搜索下载神器，海量磁力种子信息库'
    },
    {
      name: 'BT吧',
      url: 'https://www.btba.cc/',
      icon: 'https://cdn.baidu.com.btba.xiaoeryi.com/btba/favicon.ico',
      desc: 'BT吧每日更新2020年最新电影电视剧，720p|1080p|4K等超高清分辨率电影电视剧迅雷下载、bt种子网盘离线下载等资源。支持手机、ipad访问，页面打开快速稳定，欢迎访问。'
    },
    {
      name: '磁力火',
      url: 'https://edr6u.xyz/',
      icon: 'https://edr6u.xyz/assets/images/favicon.ico',
      desc: 'bt搜索下载神器,最新最全的BT搜索引擎,海量磁力种子信息库'
    },
    {
      name: '磁力王国',
      url: 'https://br6tn.xyz/',
      icon: 'https://br6tn.xyz/assets/images/favicon.png',
      desc: 'bt搜索下载神器，最新最全的BT搜索引擎，海量磁力种子信息库'
    },
    // {
    //   name: 'Zooqle',
  ...
  others: [
    ...
    // },
    {
      ...
      icon: 'https://one-piece.cn/favicon.ico',
      desc: '海贼王动画、海贼王漫画'
    },
    {
      name: '风之动漫（漫画）',
